...
namespace MetricManager.DAL.Jobs
{
    ...
    {
        private IRepositoryGet<DotNetMetric> _metricRepository;
        ...
        public DotNetMetricJob(IRepositoryGet<DotNetMetric> metricRepository, IAgentsRepository<AgentInfo> agentsRepository, IMetricsAgentClient client)
        {
        ...
        public Task Execute(IJobExecutionContext context)
        {
            ...
            {
                var temp = new GetDotNetHeapMetrisApiRequest();
                ...
                var result = _client.GetAllDotNetMetrics(temp);
